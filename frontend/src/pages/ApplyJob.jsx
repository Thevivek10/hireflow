    ...
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        {mode === 'ai-build' && (
          <div className="card">
            <div style={styles.formHeader}>
              <h2 style={styles.formTitle}>🤖 AI CV Builder</h2>
              <button onClick={() => setMode('choose')} style={styles.backBtn}>← Change</button>
            </div>
            ...
            {!generatedCV ? (
              <button onClick={generateCV} className="btn-primary" style={styles.generateBtn} disabled={aiLoading}>
                {aiLoading ? '🤖 AI is generating your CV...' : '✨ Generate Tailored CV'}
              </button>
            ) : (
              <div style={styles.cvPreview}>
                <h3 style={styles.cvPreviewTitle}>✅ AI Generated CV Preview</h3>
                ...
                <button onClick={() => setGeneratedCV(null)} style={styles.regenBtn}>🔄 Regenerate</button>
              </div>
            )}
          </div>
        )}
        ...
        {mode === 'upload' && (
          <div className="card">
            <div style={styles.formHeader}>
              <h2 style={styles.formTitle}>📄 Upload CV</h2>
              <button onClick={() => setMode('choose')} style={styles.backBtn}>← Change</button>
            </div>
          ...
          <div className="card" style={{ marginTop: 20 }}>
            ...
            <div style={styles.submitRow}>
              <p style={{ color: 'var(--text-muted)', fontSize: 13 }}>
                🤖 AI will instantly score and rank your application
              </p>
